...
**Операция:** addDriver(name, surname, phone)
...
**Операция:** addCar(stateCarNumber, gasolineConsumptionRatio, brand) 
...
**Операция:** editCar(stateCarNumber, gasolineConsumptionRatio,  brand)  
...
**Операция:** generateReport(reportSettings)   
