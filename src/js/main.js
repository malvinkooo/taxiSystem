...
ordersList.addOrder({
    ...
    destination: new Address("Приморський бульвар, 7", "46.48833171370467", "30.740929841940673"),
    carFeedPoint: new Address("Приморський бульвар, 9", "46.48733817624743", "30.741841793005737"),
    rate: 1,
    distance: 39.7
}, geoService);
ordersList.addOrder({
